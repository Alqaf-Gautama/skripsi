...
<html lang="en">
              ...
              <div class="tab-pane fade py-5 active show" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
                ...
                <div class="P-2">
                    <form method="GET">
                        <div class=" row">
                            <div class="col-md-8">
                                <input type="text" class="form-control" placeholder="Masukkan NIK" name="">
                            </div>
                            <div class="col-md-3">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | PT. Mega Karya Buana Tani by <a href="https://colorlib.com" target="_blank">Borpal Studio</a>
